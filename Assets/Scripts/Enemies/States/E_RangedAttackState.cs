...
public class E_RangedAttackState : E_AttackState
{
    ...
    public E_RangedAttackState(Entity entity, StateManager stateManager, string animBoolName, Transform attackPosition,
        D_RangedAttackState stateData) : base(entity, stateManager, animBoolName, attackPosition)
    {
