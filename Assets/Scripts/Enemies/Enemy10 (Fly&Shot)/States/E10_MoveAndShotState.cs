...
public class E10_MoveAndShotState : E_MoveAndShotState
{
    ...
    public E10_MoveAndShotState(Entity entity, StateManager stateManager, string animBoolName,
        D_MoveAndAttack stateData, Transform attackPosition, Enemy10 enemy) : base(entity, stateManager, animBoolName,
        stateData, attackPosition)
    {
        this.enemy = enemy;
    }
